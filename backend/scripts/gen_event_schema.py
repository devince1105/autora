"""Write the generated event contract into frontend/event-schema.
...
TS_OUT = ROOT / "frontend/event-schema/src/generated.ts"
JSON_OUT = ROOT / "frontend/event-schema/schema/events.catalog.json"
