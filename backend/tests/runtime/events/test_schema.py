...
# logs/platform/11_EVENT_CATALOG.md company groups. Subscriptions and payments are here, not in a
# business domain: every industry is paid the same way (T-701, D-022).
EXPECTED_COMPANY = {
    ...
    "SUBSCRIPTION_STARTED", "SUBSCRIPTION_STATE_CHANGED", "PAYMENT_RECEIVED",  # T-701
