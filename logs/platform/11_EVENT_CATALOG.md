...
| Finance | BUDGET_ALLOCATED, BUDGET_EXHAUSTED, EXPENSE_RECORDED, REVENUE_RECORDED（PAYMENT_RECEIVED 移至 Business 群組，P7） | 是 | 財務投影 | Ledger |
| Workflow | WORKFLOW_RUN_CREATED, WORKFLOW_RUN_COMPLETED, WORKFLOW_RUN_FAILED | 是 | — | TaskManager |
...
| Business (P5) | CUSTOMER_CREATED, LEAD_CREATED, OPPORTUNITY_DISCOVERED, CAMPAIGN_CREATED, CAMPAIGN_SPEND_RECORDED | 是 | — | Business domain |
